...
export type GetPageBlotPostQueryVariables = Exact<{
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type GetPageBlotPostQuery = { __typename?: 'Query', pageBlogPostCollection?: { __typename?: 'PageBlogPostCollection', items: Array<{ __typename?: 'PageBlogPost', internalName?: string | null, slug?: string | null, postTitle?: string | null, publishedDate?: any | null, postContent?: { __typename?: 'PageBlogPostPostContent', json: any } | null, featuredImage?: { __typename?: 'Asset', url?: string | null, title?: string | null, description?: string | null } | null, seo?: { __typename?: 'ComponentSeo', seoTitle?: string | null, seoDescription?: string | null, sys: { __typename?: 'Sys', id: string }, seoImage?: { __typename?: 'Asset', url?: string | null, title?: string | null, description?: string | null } | null } | null } | null> } | null };
...
type PageBlogPost implements Entry & _Node {
  ...
  postContent(locale: String): PageBlogPostPostContent
  postTitle(locale: String): String
  publishedDate(locale: String): DateTime
  seo(locale: String, preview: Boolean, where: ComponentSeoFilter): ComponentSeo
...
type PageBlogPostPostContent {
  json: JSON!
  links: PageBlogPostPostContentLinks!
}

type PageBlogPostPostContentAssets {
  block: [Asset]!
  hyperlink: [Asset]!
}

type PageBlogPostPostContentEntries {
  block: [Entry]!
  hyperlink: [Entry]!
  inline: [Entry]!
}

type PageBlogPostPostContentLinks {
  assets: PageBlogPostPostContentAssets!
  entries: PageBlogPostPostContentEntries!
  resources: PageBlogPostPostContentResources!
}

type PageBlogPostPostContentResources {
  block: [PageBlogPostPostContentResourcesBlock!]!
  hyperlink: [PageBlogPostPostContentResourcesHyperlink!]!
  inline: [PageBlogPostPostContentResourcesInline!]!
}

type PageBlogPostPostContentResourcesBlock implements ResourceLink {
  sys: ResourceSys!
}

type PageBlogPostPostContentResourcesHyperlink implements ResourceLink {
  sys: ResourceSys!
}

type PageBlogPostPostContentResourcesInline implements ResourceLink {
  sys: ResourceSys!
}
...
export const GetPageBlotPostDocument = gql`
    query getPageBlotPost($locale: String, $preview: Boolean, $slug: String) {
...
const GetPageBlotPostDocumentString = print(GetPageBlotPostDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getPageBlotPost(variables?: GetPageBlotPostQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetPageBlotPostQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetPageBlotPostQuery>(GetPageBlotPostDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getPageBlotPost', 'query', variables);
    }
  };
}
